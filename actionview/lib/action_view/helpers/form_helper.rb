  ...
  module Helpers
    ...
    module FormHelper
      ...
      def apply_form_for_options!(record, object, options) #:nodoc:
        ...
        options[:html].reverse_merge!(
          ...
          id:     (as ? [namespace, action, as] : [namespace, dom_id(object, action)]).compact.join(StringPool::UNDERSCORE).presence,
          method: method
        )
    ...
    class FormBuilder
      ...
      def self._to_partial_path
        @_to_partial_path ||= name.demodulize.underscore.sub!(/_builder$/, StringPool::EMPTY)
      end
      ...
      def fields_for(record_name, record_object = nil, fields_options = {}, &block)
        ...
        index = if options.has_key?(:index)
          ...
          self.object_name = @object_name.to_s.sub(/\[\]$/,StringPool::EMPTY)
          @auto_index
        end
